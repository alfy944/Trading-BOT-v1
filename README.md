...
export LOG_PATH="logs/trading_bot.log"
...
### Esecuzione giornaliera alle 10:00 (cron)

```bash
python trading_bot.py
```

Per usare un cron giornaliero alle 10:00:
...
```bash
0 10 * * * /home/ubuntu/Trading-BOT-v1/venv-trading-bot/bin/python /home/ubuntu/Trading-BOT-v1/trading_bot.py >> /home/ubuntu/Trading-BOT-v1/logs/cron.log 2>&1
```
...
## Avvio automatico dashboard (systemd)

Per avviare **sempre** la dashboard dopo il reboot, usa il servizio systemd incluso.
...
In alternativa puoi usare lo script `run_all.sh` per avviare la dashboard e lanciare il bot una volta:
...
Il bot scrive i log in un file con rotazione. Puoi configurare i parametri con:

- `LOG_PATH` (default: `logs/trading_bot.log`)
